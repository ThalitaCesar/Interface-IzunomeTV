...
const Footer = () => {
  return (
    <ContainerOverview style={{margin:"0"}}>
    <FooterContainer>
    <UpperRow>
    <Logo src={immb}/>
    {/* <p style={{fontSize: "14px", marginLeft:"45px"}}>A Igreja Messiânica Mundial foi fundada no Japão em 1 de janeiro de 1935, por Mokiti Okada, chamado pelos messiânicos de Meishu-Sama, que, em português significa, "Senhor Da Luz".</p> */}
    </UpperRow>
